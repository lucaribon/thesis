...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RA-01 - Variazione dei requisiti*]),
...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RA-02 - Scelte progettuali non adeguate*]),
        [*Tipologia*], [Analisi e progettazione],
        [*Probabilità*], [Media],
        [*Impatto*], [Alto],
    ),
...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RO-01 - Gestione del tempo non ottimale*]),
...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RT-01 - Inesperienza con tecnologie usate in azienda*]),
        [*Tipologia*], [Tecnico],
        [*Probabilità*], [Alta],
        [*Impatto*], [Basso],
    ),
...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RT-02 - Influenze esterne*]),
        [*Tipologia*], [Tecnico],
        [*Probabilità*], [Bassa],
        [*Impatto*], [Alto],
    ),
...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RT-03 - Messaggi duplicati*]),
        [*Tipologia*], [Tecnico],
        [*Probabilità*], [Bassa],
        [*Impatto*], [Medio],
    ),
...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RT-04 - Perdita di messaggi*]),
        [*Tipologia*], [Tecnico],
        [*Probabilità*], [Bassa],
        [*Impatto*], [Alto],
    ),
...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RT-05 - Sicurezza della comunicazione MQTT*]),
        [*Tipologia*], [Tecnico],
        [*Probabilità*], [Bassa],
        [*Impatto*], [Alto],
    ),
...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RT-07 - Errata configurazione dei lettori RFID*]),
        [*Tipologia*], [Tecnico],
        [*Probabilità*], [Bassa],
        [*Impatto*], [Alto],
    ),
...
#figure(
    table(
        ...
        table.header(table.cell(colspan: 2)[*RT-08 - Disconnessioni dei dispositivi fisici*]),
        [*Tipologia*], [Tecnico],
        [*Probabilità*], [Media],
        [*Impatto*], [Alto],
    ),
